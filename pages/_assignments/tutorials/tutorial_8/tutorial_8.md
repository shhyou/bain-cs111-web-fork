...
**Everyone must submit their `tutorial_8.rkt` file to Canvas** <mark>regardless if you're in-person or remote</mark>. As long as you complete 75% of the tasks, you will receive a 100 for the assignment, but remember you'll need to complete the parts you didn't finish before doing Exercise 8. You'll receive automated feedback on this tutorial from the autograder to make sure you're on track for Exercise 8. It will run once an hour starting on Tuesday afternoon at 5pm. **If you receive less than a 100 but higher than a 75 on the tutorial submission, your Canvas assignment grade will be manually updated on Thursday morning**. If you score below a 75, your grade will be final. <mark>You can resubmit up until 11:59pm on Wednesday evening.</mark>